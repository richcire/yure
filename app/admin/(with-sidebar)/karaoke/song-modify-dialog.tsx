...
interface SongModifyDialogProps {
  id: string;
  title: string;
  artist: string;
  tjNumber: string | null;
  kyNumber: string | null;
  joysoundNumber: string | null;
  keyword: string;
  isOpen: boolean;
  setIsOpen: (isOpen: boolean) => void;
}
export const SongModifyDialog = ({
  id,
  title,
  artist,
  tjNumber,
  ...
  isOpen,
  setIsOpen,
}: SongModifyDialogProps) => {
  const [songData, setSongData] = useState({
    title: title,
    artist: artist,
    tjNumber: tjNumber,
    kyNumber: kyNumber,
    joysoundNumber: joysoundNumber,
    keyword: keyword,
    defaultKeyword: cleanAndLowercase(title, artist),
  });
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>노래 수정</DialogTitle>
          <DialogDescription>노래의 정보를 수정하세요.</DialogDescription>
        </DialogHeader>
