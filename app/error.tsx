...
export default function Error({
  ...
  return (
    <div className="min-h-screen bg-hanji flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-comfortWhite rounded-2xl shadow-xl p-8 transform transition-all animate-fade-in">
        <div className="text-center">
          ...
          <div className="flex gap-4 justify-center">
            <button
              onClick={() => router.push("/")}
              className="bg-hanji hover:bg-hanji/80 text-primary font-semibold px-6 py-3 rounded-lg
                transform transition-all duration-200 hover:scale-105 focus:outline-none focus:ring-2 
                focus:ring-primary/20 focus:ring-offset-2 shadow-md"
            >
              홈으로 가기
            </button>
            <button
